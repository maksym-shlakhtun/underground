...
public:
	...
	void addHumanToTrain(const std::string &  _humanName, const std::string & _stationName);
	void addHumanToTrain(const std::string &  _humanName, const std::string & _stationName, int _carriageNumber);
